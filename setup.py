...
setuptools.setup(
    name='OnnxResnet50',
    version='20200725231211_51EA7C',
    description="BentoML generated model module",
    long_description="""# Generated BentoService bundle - OnnxResnet50:20200725231211_51EA7C
...
""",
    ...
    package_data={
        'OnnxResnet50': ['bentoml.yml', 'artifacts/*']
    },
    entry_points={
        'console_scripts': [
            'OnnxResnet50=OnnxResnet50:cli',
        ],
    }
)
